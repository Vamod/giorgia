@extends('layouts.app')
@section('content')
<section class="chi-sono">
    <div class="container">
        <div class="row">
            {{-- offset-lg-2  --}}
            <div class="col-lg-8">
                <div class="img-chi-sono text-center">
                    <img src="{{ asset('img/giorgia-cesarini.jpg') }}" alt="GiorgiaCesarini">
                </div>
                <h2 class="title-chi-sono text-center">CHI SONO</h2>
            ...
            <div class="col-lg-4 bkg-img">
                <img src="{{ asset('img/plant.jpg') }}" alt="leaf">
            </div>
        </div>
    </div>
</section>
